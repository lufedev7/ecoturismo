...
public class ResourcesAttractivesControllers {
    ...
    public ResponseEntity<ResourcesAttractivesDTOUse> saveResourcesAttractives(
            @PathVariable(value = "attractivesId") Long attractivesId,
            @Valid @RequestBody ResourcesAttractivesDTOUse resourcesAttractivesDTO) {
        return new ResponseEntity<>(
                resourcesAttractivesServices.createResourceAttractives(attractivesId, resourcesAttractivesDTO),
                HttpStatus.CREATED);
    }

    @GetMapping("/attractives/{attractivesId}/resourcesattractive")
    public List<ResourcesAttractivesDTO> listResourcesAttractivesByAttractives(
            @PathVariable(value = "attractivesId") Long attractivesId) {
    ...
    public ResponseEntity<ResourcesAttractivesDTO> getResourcesAttractivesById(
            @PathVariable(value = "attractivesId") Long attractivesId,
            @PathVariable(value = "resourcesattractivesId") Long resourcesattractivesId) {
        ResourcesAttractivesDTO resourcesAttractivesDTO = resourcesAttractivesServices
                .getResourceAttractivesId(attractivesId, resourcesattractivesId);
    ...
    public ResponseEntity<ResourcesAttractivesDTOUse> updateResourceAttractive(
            @PathVariable(value = "attractivesId") Long attractivesId,
            @PathVariable(value = "resourcesattractivesId") Long resourcesattractivesId,
            @Valid @RequestBody ResourcesAttractivesDTOUse resourcesAttractivesDTO) {
        ResourcesAttractivesDTOUse resourcesServicesUpdate = resourcesAttractivesServices
                .updateResourceAttractives(attractivesId, resourcesattractivesId, resourcesAttractivesDTO);
