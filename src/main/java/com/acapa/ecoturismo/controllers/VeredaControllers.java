...
public class VeredaControllers {
    ...
    public ResponseEntity<VeredaDTOUse> saveVereda(@PathVariable(value = "organizationsId") Long publicationsId,

            @PathVariable(value = "contactId") Long contactId,

            @Valid @RequestBody VeredaDTOUse veredaDTO) {
        return new ResponseEntity<>(veredaServices.createVereda(publicationsId,
                contactId, veredaDTO),
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<VeredaDTOUse> updateVeredaBy(@PathVariable(value = "organizationId") Long organizationId,

            @PathVariable(value = "veredaId") Long veredaId, @Valid @RequestBody VeredaDTOUse veredaDTO) {
        VeredaDTOUse veredaUpdate = veredaServices.updateVereda(organizationId,
                veredaId, veredaDTO);
