...
public class ServicesDTOAppById {
    private long id;
    @NotEmpty
    ...
    private Set<ResourcesServicesDTOAppUse> resourceServices;
    ...
    public Set<ResourcesServicesDTOAppUse> getResourceServices() {
        return resourceServices;
    }

    public void setResourceServices(Set<ResourcesServicesDTOAppUse> resourceServices) {
        this.resourceServices = resourceServices;
    }

    public ServicesDTOAppById() {
        super();
    }
