...
public class OrganizationsServicesImpl implements OrganizationsServices {
    ...
    public OrganizationsDTOuse createOrganization(OrganizationsDTOuse organizationsDTO) {
        Organizations organizations = mapearEntityuse(organizationsDTO);
        Organizations newOrganizations = organizationsRepository.save(organizations);
        return mapearDTOuse(newOrganizations);
    }
    ...
    public OrganizationsResponse getOrganization(int numberPage, int measure, String orderBy, String sortDir) {
        ...
        System.out.println("hola " + pageable);
    ...
    private OrganizationsDTOuse mapearDTOuse(Organizations organizations) {
        return modelMapper.map(organizations, OrganizationsDTOuse.class);
    }

    private Organizations mapearEntityuse(OrganizationsDTOuse organizationsDTO) {
