...
public class ResourcesAttractivesAttractivesImpl implements ResourcesAttractivesServices {
        ...
        public ResourcesAttractivesDTOUse createResourceAttractives(Long attractivesId,
                ...
                Attractives attractives = attractivesRepository.findById(attractivesId)
                                .orElseThrow(
                                                () -> new ResourceNotFoundException("Esta  Attractives no existe con ",
                                                                "id", attractivesId));

                resourcesAttractives.setAttractive(attractives);
                ResourcesAttractives newResourcesAttractives = resourcesAttractivesRepository
                                .save(resourcesAttractives);
        ...
        public ResourcesAttractivesDTO getResourceAttractivesId(Long attractivesId, Long idResourcesAttractives) {
                Attractives attractives = attractivesRepository.findById(attractivesId)
                                .orElseThrow(() -> new ResourceNotFoundException(" Este Atractivo", "id",
                                                attractivesId));
                ResourcesAttractives resourcesAttractives = resourcesAttractivesRepository
                                .findById(idResourcesAttractives)
                                .orElseThrow(() -> new ResourceNotFoundException(
                                                "Este Recurso de atractivo no se encuentra registrada con ", "id",
                                                idResourcesAttractives));
        ...
        public ResourcesAttractivesDTOUse updateResourceAttractives(Long attractivesId, Long idResourcesAttractives,
                ...
                Attractives attractives = attractivesRepository.findById(attractivesId)
                                .orElseThrow(() -> new ResourceNotFoundException(" it's Attractives", "id",
                                                attractivesId));
                ResourcesAttractives resourcesAttractives = resourcesAttractivesRepository
                                .findById(idResourcesAttractives)
                                .orElseThrow(() -> new ResourceNotFoundException(
                                                "Esta ResourcesAttractives no se encuentra registrada con ", "id",
                                                idResourcesAttractives));
                ...
                ResourcesAttractives resourcesAttractivesUpdate = resourcesAttractivesRepository
                                .save(resourcesAttractives);
        ...
        public void deleteResourceAttractives(Long attractivesId, Long resourcesattractivesId) {
                Attractives attractives = attractivesRepository.findById(attractivesId)
                                .orElseThrow(() -> new ResourceNotFoundException(" it's Attractives", "id",
                                                attractivesId));
                ResourcesAttractives resourcesAttractives = resourcesAttractivesRepository
                                .findById(resourcesattractivesId)
                                .orElseThrow(() -> new ResourceNotFoundException(
                                                "Esta ResourcesAttractives no se encuentra registrada con ", "id",
                                                resourcesattractivesId));

                if (!resourcesAttractives.getAttractive().getId().equals(attractives.getId())) {
                        throw new BlogAppException(HttpStatus.BAD_REQUEST,
                                        "El ResourcesAttractives no pertenece al  servicio");
                }
